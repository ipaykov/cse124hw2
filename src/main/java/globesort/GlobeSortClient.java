...
public class GlobeSortClient {
	...
	int numRecs = cmd_args.getInt("num_values");
	...
	long seconds = (end - start)/1000000000;
	long recsPerSecond = numRecs / seconds;

	long throughputTime = (seconds - sortTime)/2;
	long throughput = (numRecs * 4)/throughputTime;

	System.out.println("Application throughput: " + recsPerSecond);
	System.out.println("Network throughput: " + throughput);
	System.out.println("Latency: " + pingTime);
    }
}
